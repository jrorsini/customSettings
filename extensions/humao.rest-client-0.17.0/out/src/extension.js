...
const customVariableReferencesCodeLensProvider_1 = require("./customVariableReferencesCodeLensProvider");
const httpCodeLensProvider_1 = require("./httpCodeLensProvider");
const documentLinkProvider_1 = require("./documentLinkProvider");
const httpDocumentSymbolProvider_1 = require("./httpDocumentSymbolProvider");
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(vscode_1.commands.registerCommand('rest-client.clear-aad-token-cache', () => variableProcessor_1.VariableProcessor.clearAadTokenCache()));
        ...
        context.subscriptions.push(vscode_1.languages.registerCodeLensProvider('http', new customVariableReferencesCodeLensProvider_1.CustomVariableReferencesCodeLensProvider()));
        ...
        context.subscriptions.push(vscode_1.languages.registerDocumentSymbolProvider('http', new httpDocumentSymbolProvider_1.HttpDocumentSymbolProvider()));
    });
}
