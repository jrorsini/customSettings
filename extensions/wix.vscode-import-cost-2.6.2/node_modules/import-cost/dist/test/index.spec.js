...
var test = function () {
  ...
  return function test(_x5) {
    return _ref.apply(this, arguments);
  };
}();

var timed = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(fn) {
    var time, diff;
...
function importCost(fileName) {
  ...
  return (0, _src.importCost)(fileName, _fs2.default.readFileSync(fileName, 'utf-8'), language);
}
...
describe('importCost', function () {
  ...
  it('calculates size of mixed import in javascript', function () {
    return test('import-mixed.js');
  });
  it('calculates size of mixed import in typescript', function () {
  ...
  it('calculates size of shaken import in javascript', function () {
    return test('import-shaken.js', 'react', 500, 1000);
  });
  it('calculates size of shaken import in typescript', function () {
    return test('import-shaken.ts', 'react', 500, 1000);
  });
  it('calculates size of production env import in javascript', function () {
    return test('import-env.js', 'react-dom', 500, 1000);
  });
  it('calculates size of production env import in typescript', function () {
    return test('import-env.ts', 'react-dom', 500, 1000);
  });
  it('calculates size without externals', function () {
    return test('import-externals.js', 'wix-style', 500, 1000);
  });
  it('calculates size without peerDependencies', function () {
    return test('import-peer.js', 'haspeerdeps', 0, 1000);
  });

  it('caches the results import string & version', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
  ...
  it('debounce any consecutive calculations of same import line', function () {
    var p1 = (0, _chai.expect)(whenDone((0, _src.importCost)(fixture('import.js'), 'import "chai";', _src.JAVASCRIPT))).to.be.rejectedWith(_debouncePromise.DebounceError);
    var p2 = (0, _chai.expect)(whenDone((0, _src.importCost)(fixture('import.js'), 'import "chai/index";', _src.JAVASCRIPT))).to.be.fulfilled;
    return _promise2.default.all([p1, p2]);
  });
  it('caches everything to filesystem', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            (0, _context4.t2)(_context4.t3).to.be.within(100, 1500);
          ...
          case 16:
            ...
            (0, _context4.t4)(_context4.t5).to.be.within(0, 100);
  ...
  it('results in 0 if dependency is missing', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
    var packages;
  ...
  it('results in 0 if bundle fails', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6() {
    var packages;
  ...
  it('completes with empty array for unknown file type', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
    var packages;
